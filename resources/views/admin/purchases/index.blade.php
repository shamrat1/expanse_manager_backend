...
{{-- @can('purchase_create') --}}
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-primary" href="{{route("admin.purchases.import") }}">
                {{ trans('global.import') }} {{ trans('cruds.purchase.title_singular') }}
            </a>
        </div>
    </div>
{{-- @endcan --}}
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-purchase">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.purchase.fields.rate') }}
                        </th>
                        <th>
                            {{ trans('cruds.purchase.fields.total_amount') }}
                        </th>
                        <th>
                            {{ trans('cruds.purchase.fields.discount') }}
                        </th>
                        <th>
                            {{ trans('cruds.purchase.fields.total_payment') }}
                        </th>
                        <th>
                            {{ trans('cruds.purchase.fields.paid') }}
                        </th>
                        <th>
                            {{ trans('cruds.purchase.fields.prev_due') }}
                        </th>
                        <th>
                            {{ trans('cruds.purchase.fields.due') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
